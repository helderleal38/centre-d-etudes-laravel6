            ...
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="tab-pane fade" id="re_registration" role="tabpanel" aria-labelledby="list-profile-list">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header text-center bg-primary"><h2>Renouvellement de la pré-inscription</h2></div>
                                <div class="card-body">
                                    <form method="post" action="{{route('student_update', $studentId[0]->id)}}">
                                        @csrf                                
                                        @method('PUT')
                                        <div class="form-group row">
                                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Nom') }}</label>
                                        ...
                                        <div class="form-group row">
                                            <label for="scoolName" class="col-md-4 col-form-label text-md-right">{{ __('Ecole') }}</label>
                                            <div class="col-md-6">
                                                <input id="scoolName" type="text" class="form-control @error('scoolName') is-invalid @enderror" name="scoolName" value="{{ $studentId[0]->scoolName }}" required autocomplete="scoolName" autofocus>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="year" class="col-md-4 col-form-label text-md-right">{{ __('Année scolaire') }}</label>
                                            <div class="col-md-6">
                                                <select class="form-control" id="year" type="text" name="year" value="{{ $studentId[0]->year }}">
                                                    <option>{{ $studentId[0]->year }}</option>
                                                    <option>Cp</option>
                                                    <option>Ce1</option>
                                                    <option>Ce2</option>
                                                    <option>Cm1</option>
                                        ...
                                        <div class="form-group row">
                                            <label for="matter" class="col-md-4 col-form-label text-md-right">{{ __('Matière souhaité') }}</label>
                                            <div class="col-md-6">
                                                <select class="form-control" id="matter" type="text" name="matter" value="{{ $studentId[0]->matter }}">
                                                    <option>Mathematique</option>
                                                    <option>Anglais</option>
                                                    <option>Histoire</option>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            <label for="responsible" class="col-md-4 col-form-label text-md-right">{{ __('Responsable légal') }}</label>
                                            <div class="col-md-6">                   
                                                <input id="responsible" type="text" class="form-control @error('responsible') is-invalid @enderror" name="responsible" value="{{ $studentId[0]->responsible }}" required autocomplete="responsible" autofocus>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="address" class="col-md-4 col-form-label text-md-right">{{ __('Adresse') }}</label>
                                            <div class="col-md-6">
                                                <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ $studentId[0]->address }}" required autocomplete="address" autofocus>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Email') }}</label>
                                        ...
                                        <div class="form-group row">
                                            <label for="phoneNumber" class="col-md-4 col-form-label text-md-right">{{ __('Téléphone') }}</label>
                                            <div class="col-md-6">
                                                <input id="phoneNumber" type="text" class="form-control @error('phoneNumber') is-invalid @enderror" name="phoneNumber" value="{{ $studentId[0]->phoneNumber }}" required autocomplete="phoneNumber" autofocus>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-0">
                                            <div class="col-md-6 offset-md-4">
