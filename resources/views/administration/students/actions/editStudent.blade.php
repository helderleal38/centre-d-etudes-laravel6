            ...
            <form method="post" action="{{route('student_update', $studentId[0]->id)}}">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  ...
                  value="{{ $studentId[0]->scoolName }}" required autocomplete="scoolName" autofocus>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">                   
                  ...
                  name="responsible" value="{{ $studentId[0]->responsible }}" required autocomplete="responsible" autofocus>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  ...
                  value="{{ $studentId[0]->address }}" required autocomplete="address" autofocus>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                    ...
                    name="phoneNumber" value="{{ $studentId[0]->phoneNumber }}" required autocomplete="phoneNumber" autofocus>
