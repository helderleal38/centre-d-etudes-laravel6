...
<section class="content">
    ...
    <!-- Grid column -->
    <!-- Grid column -->
    <div class="col-lg-6 col-md-12 mb-md-2 mb-4 mt-xl-4">
        <h3 class="font-weight-normal mb-4">COURS PARTICULIERS</h3>
        <p class="text-muted">De nombreux élèves manquent d’organisation, de méthode de travail ou de temps pour approfondir les notions vues en classe. Vasco Soares vous propose des cours particuliers chez nous ou à domicile, avec des enseignants qualifiés pour revoir ou approfondir ces points précis. Votre enfant se sentira soutenu et travaillera plus sereinement.</p>
        <!-- <a class="btn btn-outline-primary mx-0" href="#">Inscrivez-vous<i class="fas fa-arrow-right fs-9 ml-2"></i></a> -->
...
<section class="content">
    ...
    <div class="row">
    <!-- Grid column -->
    <div class="col-lg-6 col-md-12 mb-md-0 mb-4 mt-xl-4">
...
<section class="content">
    ...
    <!-- Grid column -->
    <!-- Grid column -->
    <div class="col-lg-6 col-md-12 mb-md-4 mb-4 mt-xl-4">
